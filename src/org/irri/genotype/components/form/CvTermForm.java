...
public class CvTermForm extends Composite implements LoaderForm {
	...
	public CvTermForm(final Composite parent, int style) {
		...
		txtCvTermbox.setBounds(128, 34, 224, 25);
		...
		dbXrefcomboBx.setBounds(128, 94, 168, 23);
		toolkit.adapt(dbXrefcomboBx);
		toolkit.paintBordersFor(dbXrefcomboBx);

		btnCvTerm = new Button(this, SWT.NONE);
		btnCvTerm.setText("New DB Xref");
		btnCvTerm.setBounds(297, 93, 55, 25);
		toolkit.adapt(btnCvTerm, true, true);
		btnCvTerm.addListener(SWT.Selection, new Listener() {
		...
		cvComboBx.setBounds(128, 7, 168, 23);
